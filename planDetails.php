...
if($res){
	...
	echo "<tr>
		...
		<td height='35'>&nbsp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;<input id='boxx' type='text' value='".$row['amount']."' readonly><br>git </td></tr>
		<tr>
